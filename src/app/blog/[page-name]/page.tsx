...
export async function generateMetadata({
  ...
  const fallbackMetadata: Metadata = {
    ...
    description:
      "Read expert articles, moving guides, and packing tips on Eintransport blog.",
  ...
  try {
    ...
    if (blog) {
      ...
      const keywords = blog.metaKeywords?.length
        ? blog.metaKeywords
        : undefined;
      const blogCanonicalUrl = buildCanonicalUrl(blog.pageURL);
      const finalDescription =
        description || `Read ${blog.title} on Eintransport blog.`;
