...
export default function Component() {
  ...
  return (
    <>
      {/* Header */}
      <header
        className={`text-white bg-gray-800 py-3 px-4 sm:px-6 md:px-12 lg:px-24 sticky top-0 z-50 backdrop-blur-sm transition-all duration-500 ${
          isVisible
      ...
      >
        <div className="mx-auto flex justify-between items-center">
          <div className="text-lg sm:text-2xl md:text-3xl font-bold text-[#0086FF] hover:scale-105 transition-transform duration-300 cursor-pointer">
  ...
  "
                ...
                >
                  Get fast and secure moving solutions from professionals.
                  Request your free, no-obligation quote today and let us handle
                  the shifting.{" "}
                </motion.p>
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
              ...
              >
                ...
                <p className="text-gray-600 text-base sm:text-lg mb-8 leading-relaxed">
                  ...
                  your home or office, we've got you covered from start to
                  finish.
                </p>
                <Link
          ...
          >
            ...
            <div className="bg-white/80 backdrop-blur-sm rounded-3xl p-8 sm:p-12 shadow-xl border border-white/20">
              <p className="text-lg sm:text-xl md:text-2xl text-gray-700 leading-relaxed">
                ...
                across cities. With a trusted team, reliable vehicles, and a
                focus on quick and safe service, we make every move{" "}
