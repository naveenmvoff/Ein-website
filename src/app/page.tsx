...
import { bestHouse, localShitingCost, packingCost, whyChoose, anotherCity, testimonials, DeliveryConfirm, StoreageDamageProduction, ContactTodayData } from "@/lib/dataSet";
