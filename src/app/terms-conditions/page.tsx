...
import { FileText, AlertCircle, Shield, Ban, ExternalLink, Gavel, Mail, Globe } from "lucide-react";
...
const sections = [
  ...
  },
  {
    ...
    content: {
      ...
      footer: "Refunds for eligible cancellations will be processed within 3–5 working days."
    }
  },
  {
    id: 3,
  ...
  },
  {
    ...
    content: {
      ...
      footer: "The Company is not responsible for losses caused by incorrect information or unsafe packing done by the customer"
    }
  },
  {
    id: 5,
  ...
  },
  {
    ...
    content: {
      ...
      footer: "All website content is owned by Eintransport Private Limited and protected under applicable Indian copyright laws."
    }
  },
  {
    id: 9,
    ...
    content: {
      ...
      footer: "The Company is not responsible for the accuracy, reliability, safety or content of third-party websites."
    }
  },
  {
    id: 10,
      ...
      <div className="container mx-auto px-3 sm:px-6 lg:px-8 max-w-5xl py-6 sm:py-8 md:py-10">
        ...
        <div className="bg-white rounded-lg shadow-md border border-gray-200 p-4 sm:p-5 md:p-6 mb-6">
          <p className="text-sm sm:text-base text-gray-700 leading-relaxed">
            By using <span className="font-semibold text-[#0086ff]">Eintransport Packers and Movers</span> ("Company", "We", "Us") and our website{" "}
            <Link href={"/"} className="text-[#0086ff] hover:underline font-medium">
              eintransport.in
            </Link>
                    ...
                    {section.content.list && (
                      <ul className="space-y-2 mb-3">
                        {section.content.list.map((item, index) => (
                          ...
                          >
                            <span className="text-[#0086ff] mt-1.5 flex-shrink-0">•</span>
