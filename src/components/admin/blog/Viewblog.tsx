...
export default function ViewBlogPage({ id }: { id: string }) {
      ...
      <div className="min-h-screen bg-gray-50 p-6">
        <div className="max-w-4xl mx-auto">
          <div className="bg-red-50 border border-red-200 rounded-md p-6 text-red-700">
            ...
            <Link
              href="/admin/sdkjfhsdkfjhdskjfhkjsdfhkjsdfhdskjfhdskjfh/dhkjfhksjdhfkjsdfhkjsdfhkjdsfh/blog"
  ...
  const formattedCreatedDate =
    createdDateValue && !isNaN(createdDateValue.getTime())
      ? createdDateValue.toLocaleDateString()
      : "—";
  const updatedDateValue = blog.updatedAt ? new Date(blog.updatedAt) : null;
  const formattedUpdatedDate =
    updatedDateValue && !isNaN(updatedDateValue.getTime())
      ? updatedDateValue.toLocaleDateString()
      : null;
