...
export default function HeaderNavbar() {
  ...
  return (
    <header ref={headerRef} className="fixed top-0 left-0 w-full z-50 bg-white shadow-sm border-b border-gray-100">
      <div className="max-w-7xl mx-auto flex justify-between items-center h-16 px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          />
          <span className="hidden sm:block text-lg font-semibold text-[#0086ff]">
        ...
        <nav className="hidden sm:flex items-center space-x-6 text-sm font-medium text-gray-700">
          ...
          >
            <button className="flex items-center gap-1 hover:text-[#0086ff] transition-colors py-2">
              Service Location <ChevronDown className="h-4 w-4" />
            </button>
            ...
            <AnimatePresence>
              {isServicesOpen && (
                <motion.div
                  ...
                  className="absolute left-1/2 -translate-x-1/2 mt-2 w-52 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden"
                >
                  {locations.map((loc) => (
                    <Link
                      key={loc.slug}
                      href={`/packers-and-movers/${loc.slug}`}
                      className="block px-4 py-2.5 text-sm text-gray-700 hover:bg-blue-50 hover:text-[#0086ff] transition-colors"
                    >
                      {loc.name}
                    </Link>
                  ))}
          ...
          <a href="#about" className="hover:text-[#0086ff] transition-colors py-2">
            About
          </a>
          <a href="#contact" className="hover:text-[#0086ff] transition-colors py-2">
            Contact
          </a>
          <a href="#faq" className="hover:text-[#0086ff] transition-colors py-2">
            FAQ
          </a>
        </nav>
      ...
      <AnimatePresence>
        {isMenuOpen && (
          ...
          >
            <div className="flex flex-col py-3 px-4 text-sm font-medium text-gray-700">
              {/* Services Dropdown */}
              <div className="w-full">
                <button
                  className="w-full flex justify-between items-center py-3 px-2 hover:text-[#0086ff] transition-colors"
                    ...
                    >
                      {locations.map((loc) => (
                        <Link
                          ...
                          href={`/packers-and-movers/${loc.slug}`}
                          onClick={closeMenu}
                          className="block py-2 px-2 text-sm text-gray-600 hover:text-[#0086ff] hover:bg-blue-50 rounded transition-colors"
                        >
                          {loc.name}
                        </Link>
                      ))}
              ...
              <a
                href="#about"
                onClick={closeMenu}
                className="py-3 px-2 hover:text-[#0086ff] transition-colors"
              >
                About
              </a>
              <a
      ...
      <AnimatePresence>
        {isPhoneSticky && !isMenuOpen && !isServicesOpen && (
          ...
          >
            <div className="w-full bg-[#0086ff] shadow-sm">
              <div className="max-w-7xl mx-auto py-2 flex justify-center">
                <a
                  href={`tel:${PHONE_HREF}`}
                  className="flex items-center text-white text-sm sm:text-base font-semibold hover:opacity-90 transition-opacity"
